...
Infinite Wordle is a small personal project made for fun. Choose a four-, five-, or six-letter puzzle, solve it in six guesses, or start a fresh practice round whenever you like. It may not receive regular updates.

## What’s included

- Four-, five-, and six-letter daily and practice games
...
This is a casual, low-maintenance project rather than an actively developed product. The playable page is [`WORDLE.html`](WORDLE.html). It loads separate maintained solution and accepted-word sources for each length from the same GitHub Pages site: [`data/solutions-4.txt`](data/solutions-4.txt), [`data/accepted-4.txt`](data/accepted-4.txt), [`data/solutions.txt`](data/solutions.txt), [`data/accepted-words.txt`](data/accepted-words.txt), [`data/solutions-6.txt`](data/solutions-6.txt), and [`data/accepted-6.txt`](data/accepted-6.txt).
